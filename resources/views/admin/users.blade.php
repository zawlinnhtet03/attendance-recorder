                        ...
                        @else
                            <table class="table table-striped table-hover mb-0 border border-gray-300">
                                <thead class="student-thread">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-white text-lg border-b-2 border-gray-300">Name</th>
                                        <th class="px-6 py-3 text-left text-white text-lg border-b-2 border-gray-300">Organization</th>
                                        <th class="px-6 py-3 text-left text-white text-lg border-b-2 border-gray-300">Email</th>
                                        <th class="px-6 py-3 text-left text-white text-lg border-b-2 border-gray-300">Check-in Time</th>
                                        <th class="px-6 py-3 text-left text-white text-lg border-b-2 border-gray-300">Check-out Time</th>
                                    </tr>
                                </thead>
